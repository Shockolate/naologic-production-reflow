export type ReflowDocumentType =
  | 'workOrder'
  | 'workCenter'
  | 'manufacturingOrder';
...
export function isReflowDocument(
  document: unknown,
): document is ReflowDocument {
  return (
...
export function isWorkOrderDocument(
  document: unknown,
): document is WorkOrderDocument {
...
export function isWorkCenterDocument(
  document: unknown,
): document is WorkCenterDocument {
...
export function isManufacturingOrderDocument(
  document: unknown,
): document is ManufacturingOrderDocument {
  return (
    isReflowDocument(document) && document.docType === 'manufacturingOrder'
  );
}
